...
// Component
const ThursdayMincha = ({ thursday }) => {
  // console.log('thursday in ThursdayMincha: ', thursday);

  const { going, notGoing } = thursday;

  // console.log('going in ThursdayMincha: ', going);
  // console.log('notGoing in ThursdayMincha: ', notGoing);
      ...
      <div className="card z-depth-0">
        <div className="card-content grey-text text-darken-3">
          <span className="card-title">
            <span className="bold-text-style">Thursday Mincha</span>
          </span>
...
export default ThursdayMincha;

// Prop Types
ThursdayMincha.propTypes = {
